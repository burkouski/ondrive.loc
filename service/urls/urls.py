...
urlpatterns = patterns('service.views',
    ...
    url(r'^api/v1/service/autoservice/$', views.AutoserviceList.as_view(), name='autoservice_api_list'),
    url(r'^api/v1/service/carwash/$', views.CarWashList.as_view(), name='carwash_api_list'),
    url(r'^api/v1/service/tireservice/$', views.TireServiceList.as_view(), name='tireservice_api_list'),
